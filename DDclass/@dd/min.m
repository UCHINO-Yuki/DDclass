function [m,i] = min(a,b,opt1,opt2,opt3,opt4,opt5)
...
switch nargin
    case 7
        ...
        if isempty(a)
            m = dd(min(a.v1,[],dim,opt2,opt3,opt4,opt5));
            i = m;
            return;
        end
        linear = true;
    ...
    case 6
        if strcmp(opt1,"linear")
            ...
            if isempty(a)
                m = dd(min(a.v1,[],opt1,opt2,opt3,opt4));
                i = m;
                return;
            end
            linear = true;
            ...
            if isempty(a)
                m = dd(min(a.v1,[],dim,opt2,opt3,opt4));
                i = m;
                return;
            end
            if ismember(opt2,missingflaglist(3:4))
...
if onlyA
    ...
    if omitnan
        ...
        m1 = min(a.v1,[],dim,"includenan");
        inan = isnan(a.v1);
        i1 = a.v1 == m1 | inan;
        A2 = Inf(i1);
        A2(i1) = a.v2(i1);
        m2 = min(A2,[],dim,"includenan");
        i2 = A2 == m2 | inan;
    end
    itmp = i1 & i2;
